            ...
            <div class="row">
                        ...
                        <div class="panel-body">
                            @php
                                ...
                                $exclude = ['title', 'body', 'excerpt', 'slug', 'status', 'category_id', 'author_id',
                                 'featured', 'image', 'seo_description', 'seo_h1', 'seo_title'];
                            @endphp
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel-bordered panel-info">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <label for="seo_description">{{ __('voyager::post.seo_description') }}</label>
                                @include('voyager::multilingual.input-hidden', [
                            ...
                            <div class="form-group">
                                <label for="seo_h1">{{ __('voyager::post.seo_h1') }}</label>
                                @include('voyager::multilingual.input-hidden', [
                                    '_field_name'  => 'seo_h1',
                                    '_field_trans' => get_field_translations($dataTypeContent, 'seo_h1')
                                ])
                                <textarea class="form-control" name="seo_h1">{{ $dataTypeContent->seo_h1 ?? ''
                                }}</textarea>
                            </div>
                            <div class="form-group">
